...
def generate_weekly_eligible_list_new_experiment(
    ...
    du_campaign_child_code_low_score_new_experiment,
    du_control_campaign_child_code_low_score_new_experiment,
