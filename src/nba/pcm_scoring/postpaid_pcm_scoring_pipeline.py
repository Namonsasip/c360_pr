...
def create_nba_pcm_postpaid_scoring_pipeline() -> Pipeline:
    return Pipeline(
        [
            ...
            #         "model_group_binary": "params:nba_postpaid_model_group_binary_column",
            #         "model_group_regression": "params:nba_postpaid_model_group_regression_column",
            #         "nba_postpaid_model_group_column_push_campaign": "params:nba_postpaid_model_group_column_push_campaign",
            #         "nba_postpaid_model_group_column_pull_campaign": "params:nba_postpaid_model_group_column_pull_campaign",
