...
def date_range(start_dt, end_dt = None):
    ...
    if end_dt: end_dt = datetime.strptime(end_dt, "%Y-%m-%d")
...
def create_use_case_view_report_data() -> Pipeline:
    # mock_report_running_date = "2020-06-06"  # fixed date
    ...
    return Pipeline(
        [
            ...
            node(
                ...
                outputs="general_marketing_performance_report_tbl",
