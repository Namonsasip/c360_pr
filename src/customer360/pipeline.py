...
from .pipelines.data_engineering.pipelines.digital_pipeline.to_l3.to_l3_pipeline import (
    ...
    digital_to_l3_digital_combine_feature_monthly_cast,
    ...
    digital_to_l3_combine_category_timeband_monthly_cast,
...
def create_c360_pipeline(**kwargs) -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "digital_to_l3_digital_combine_feature_monthly_cast": digital_to_l3_digital_combine_feature_monthly_cast(),
        ...
        "digital_to_l3_combine_category_timeband_monthly_cast": digital_to_l3_combine_category_timeband_monthly_cast(),
        ...
        "campaign_to_l1_pipeline_hdfs": campaign_to_l1_pipeline_hdfs(),
