...
from .pipelines.data_engineering.pipelines.usage_pipeline import (
    ...
    usage_to_l4_pipeline_sum1,
    usage_to_l4_pipeline_sum2,
    usage_to_l4_pipeline_sum3,
    usage_to_l4_pipeline_sum4,
    usage_to_l4_pipeline_sum5,
    usage_to_l4_pipeline_sum6,
...
def create_c360_pipeline(**kwargs) -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "usage_to_l4_pipeline_sum1": usage_to_l4_pipeline_sum1(),
        "usage_to_l4_pipeline_sum2": usage_to_l4_pipeline_sum2(),
        "usage_to_l4_pipeline_sum3": usage_to_l4_pipeline_sum3(),
        "usage_to_l4_pipeline_sum4": usage_to_l4_pipeline_sum4(),
        "usage_to_l4_pipeline_sum5": usage_to_l4_pipeline_sum5(),
        "usage_to_l4_pipeline_sum6": usage_to_l4_pipeline_sum6(),
