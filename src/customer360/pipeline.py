...
from .pipelines.data_engineering.pipelines.revenue_pipeline import (
    ...
    revenue_to_l3_revenue_by_vas_s_wifi_revenue_prepost_pipeline,
...
def create_c360_pipeline(**kwargs) -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "revenue_to_l3_revenue_by_vas_s_wifi_revenue_prepost_pipeline": revenue_to_l3_revenue_by_vas_s_wifi_revenue_prepost_pipeline(),
