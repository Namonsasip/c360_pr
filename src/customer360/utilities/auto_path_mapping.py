...
def auto_path_mapping_project_context(catalog, running_environment):
    ...
    if running_environment.lower() == 'on_premise':
        ...
        metadata_path_master = catalog.load("params:metadata_path_master")['on_premise_metadata_master']
        ...
        metadata_path_master = catalog.load("params:metadata_path_master")['on_cloud_metadata_master']
            ...
            if type(catalog._data_sets[curr_catalog]).__name__ == "SparkDbfsDataSet"\
                ...
                if search_pattern.lower() in original_path_lower:
                    ...
                    try:
                        ...
                        new_meta_data_path1 = meta_data_path.replace("metadata_master", metadata_path_master)
