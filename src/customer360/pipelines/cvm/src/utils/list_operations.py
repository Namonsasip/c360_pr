...
def list_sub(list1: List[Any], list2: List[Any]) -> List[Any]:
    """ Calculates difference of two given lists.

    Args:
        list1: List to subtract from.
        list2: List to subtract.
    Returns:
...
def list_intersection(*args: List[Any]) -> List[Any]:
    """ Calculates intersection of given lists.

    Args:
        args: Lists to intersect.
    Returns:
    ...
    return functools.reduce(intersect_two, args)
