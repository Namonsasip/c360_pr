...
#
#
# def build_loyalty_number_of_points_spend_monthly(l1_loyalty_number_of_points_spend_daily: DataFrame,
#                                                  l0_loyalty_priv_project: DataFrame,
#                                                  l0_loyalty_priv_category: DataFrame,
#                                                  l1_loyalty_priv_point_transaction_daily: DataFrame,
#                                                  l3_loyalty_number_of_points_spend_monthly: dict) -> DataFrame:
#     """
#     :param l1_loyalty_number_of_points_spend_daily:
#     :param l0_loyalty_priv_project:
#     :param l0_loyalty_priv_category:
#     :param l1_loyalty_priv_point_transaction_daily:
#     :param l3_loyalty_number_of_points_spend_monthly:
#     :return:
#     """
#     ################################# Start Implementing Data availability checks #############################
#     if check_empty_dfs([l1_loyalty_number_of_points_spend_daily, l0_loyalty_priv_project,
#                         l0_loyalty_priv_category, l1_loyalty_priv_point_transaction_daily]):
#         return get_spark_empty_df()
#
#     input_df = data_non_availability_and_missing_check(df=l1_loyalty_number_of_points_spend_daily, grouping="monthly",
#                                                        par_col="event_partition_date",
#                                                        target_table_name="l3_loyalty_number_of_points_spend_monthly")
#
#     points = data_non_availability_and_missing_check(df=l1_loyalty_priv_point_transaction_daily, grouping="monthly",
#                                                      par_col="event_partition_date",
#                                                      target_table_name="l3_loyalty_number_of_points_spend_monthly")
#
#     if check_empty_dfs([input_df, points, l0_loyalty_priv_project, l0_loyalty_priv_category]):
#         return get_spark_empty_df()
#
