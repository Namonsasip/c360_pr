...
def massive_processing(input_df, customer_prof_input_df, priv_project, join_function, sql, partition_date,
                       cust_partition_date, output_df_catalog):
    """
    :return:
    """
    ...
    for curr_item in add_list:
        ...
        if len(output_df.head(1)) == 0:
            print(
                "Empty dataframe for writing from node_from_config function's output to massive_processing for partition:",
                curr_item)
        else:
