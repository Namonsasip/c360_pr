...
def stream_process_ru_a_onair_vimmi(vimmi_usage_daily: DataFrame ,
    ...
    for curr_item in add_list:
        ...
        int_l1_streaming_content_type_features = node_from_config(small_df, int_l1_streaming_content_type_features_dict)
        joined_int_l1_streaming_content_type_features = cust_df.join(
            int_l1_streaming_content_type_features, join_cols, 'left')
        CNTX.catalog.save("int_l1_streaming_content_type_features", joined_int_l1_streaming_content_type_features)

        l1_streaming_fav_content_group_by_volume_df = node_from_config(joined_int_l1_streaming_content_type_features,
                                                                        l1_streaming_fav_content_group_by_volume_dict)
        CNTX.catalog.save("l1_streaming_fav_content_group_by_volume", l1_streaming_fav_content_group_by_volume_df)

        l1_streaming_fav_content_group_by_duration_df = node_from_config(joined_int_l1_streaming_content_type_features,
                                                                         l1_streaming_fav_content_group_by_duration_dict)
        CNTX.catalog.save("l1_streaming_fav_content_group_by_duration", l1_streaming_fav_content_group_by_duration_df)


        # section for int_l1_streaming_tv_channel_features
        int_l1_streaming_tv_channel_features = node_from_config(small_df, int_l1_streaming_tv_channel_features_tbl_dict)
        joined_int_l1_streaming_tv_channel_features = cust_df.join(
            int_l1_streaming_tv_channel_features, join_cols, 'left')
        CNTX.catalog.save("int_l1_streaming_tv_channel_features", joined_int_l1_streaming_tv_channel_features)

        l1_streaming_fav_tv_channel_by_volume_df = node_from_config(joined_int_l1_streaming_tv_channel_features,
                                                                         l1_streaming_fav_tv_channel_by_volume_dict)
        CNTX.catalog.save("l1_streaming_fav_tv_channel_by_volume", l1_streaming_fav_tv_channel_by_volume_df)

        l1_streaming_fav_tv_channel_by_duration_df = node_from_config(joined_int_l1_streaming_tv_channel_features,
                                                                      l1_streaming_fav_tv_channel_by_duration_dict)
        CNTX.catalog.save("l1_streaming_fav_tv_channel_by_duration", l1_streaming_fav_tv_channel_by_duration_df)
    ...
    return [joined_int_l1_streaming_content_type_features, joined_int_l1_streaming_tv_channel_features,
            l1_streaming_fav_content_group_by_volume_df, l1_streaming_fav_content_group_by_duration_df,
