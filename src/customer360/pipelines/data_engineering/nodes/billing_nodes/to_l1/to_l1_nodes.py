...
def billing_topup_count_and_volume_node(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_recharge_data_with_customer_profile, sql,'recharge_date', 'event_partition_date', "l1_billing_and_payments_daily_topup_and_volume")
    return return_df
...
def billing_daily_rpu_roaming(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_roaming_data_with_customer_profile, sql,'date_id','event_partition_date', "l1_billing_and_payments_daily_rpu_roaming")
    return return_df
...
def billing_before_topup_balance(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_sa_account_data_with_customer_profile, sql,'recharge_date', 'event_partition_date',"l1_billing_and_payments_daily_before_top_up_balance")
    return return_df
...
def billing_topup_channels(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_recharge_data_with_customer_profile, sql,'recharge_date', 'event_partition_date',"l1_billing_and_payments_daily_top_up_channels")
    return return_df
...
def billing_most_popular_topup_channel(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_recharge_data_with_customer_profile, sql,'recharge_date', 'event_partition_date',"l1_billing_and_payments_daily_most_popular_top_up_channel")
    return return_df
...
def billing_popular_topup_day_hour(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_recharge_data_with_customer_profile, sql,'recharge_date', 'event_partition_date',"l1_billing_and_payments_daily_popular_topup_day")
    return return_df
...
def billing_time_since_last_topup(input_df, customer_prof, sql) -> DataFrame:
    ...
    :return:
    """
    return_df = massive_processing(input_df, customer_prof, daily_recharge_data_with_customer_profile, sql,'recharge_date', 'event_partition_date',"l1_billing_and_payments_daily_time_since_last_top_up")
    return return_df
