...
def popular_top_up_channel_with_rank(input_df):
    ...
    access_method_num,
    register_date,
    payments_top_up_channel order by payments_total_top_up desc""")
    ...
    access_method_num,
    register_date order by payments_total_top_up desc) as rank
    from df""")
...
def bill_volume(input_df):
    ...
    account_identifier,
    sum(bill_stmt_tot_invoiced_amt) as payments_bill_volume
