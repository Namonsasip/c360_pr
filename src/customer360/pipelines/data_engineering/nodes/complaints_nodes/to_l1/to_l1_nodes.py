...
def l1_complaints_shop_training(input_complaint, input_cust):
    ...
    input_complaints.complaints.registerTempTable("complaints_acc_qmt_csi")
    stmt="""
...
def l1_complaints_ai_chatbot_training_survey_training(input_df, config):
