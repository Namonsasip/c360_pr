...
where 
(survey_result in ('Very Dissatisfied','Dissatisfied','Neutral','Satisfied','Very Satisfied','ไม่พอใจมาก','ไม่พอใจ','ปานกลาง','พอใจ','พอใจมาก')
...
group by partition_date, access_method_num
    ...
    cond=[df.acess_method_num==input_cust.access_method_num,df.event_partition_date==input_cust.event_partition_date]
