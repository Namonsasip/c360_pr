...
################## Join url and argument ###########################
    ...
    # -------------------------------- share ----------------------------
    mobile_web_hourly_raw = mobile_web_hourly_raw.withColumn("total_visit_count", 'total_visit_count_daily')
    mobile_web_hourly_raw = mobile_web_hourly_raw.withColumn("total_visit_duration", 'total_visit_duration_daily')
    mobile_web_hourly_raw = mobile_web_hourly_raw.withColumn("total_volume_byte", 'total_volume_byte_daily')
    mobile_web_hourly_raw = mobile_web_hourly_raw.withColumn("total_download_byte", 'total_download_byte_daily')
    mobile_web_hourly_raw = mobile_web_hourly_raw.withColumn("total_upload_byte", 'total_upload_byte_daily')
