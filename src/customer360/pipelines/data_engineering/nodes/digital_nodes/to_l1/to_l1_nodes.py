...
def l1_digital_customer_web_category_agg_union_daily(mobile_web_daily_agg: DataFrame,cxense_daily: DataFrame,aib_categories_clean: DataFrame,cat_level: dict,mobile_web_daily_agg_sql: dict) -> DataFrame:
    ...
    #---------- select data --------------#
    mobile_web_daily_agg = mobile_web_daily_agg.select("subscription_identifier","mobile_no",aib_categories_clean.category_name,"total_visit_count","total_visit_duration","total_volume_byte","total_download_byte","total_upload_byte","event_partition_date")
