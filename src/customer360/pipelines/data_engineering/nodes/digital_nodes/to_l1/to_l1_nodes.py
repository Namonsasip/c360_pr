...
def digital_customer_web_network_company_usage_hourly(
    ...
    customer_web_network_company_usage_hourly = df_traffic.withColumn("ais_sim_flag",f.when(f.col("network_type") == "mobile" & f.col("network_company") IN ('ais 3g4g','ais mobile'), "1").otherwise("0"))
