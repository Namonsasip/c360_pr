...
def l3_digital_mobile_web_category_agg_timeband (digital_customer_web_category_agg_timeband: DataFrame) -> DataFrame :
    ...
    df_web_monthly_timeband_agg_category = df_web_monthly_timeband.groupBy("mobile_no","category_name",
                                                                           "priority","start_of_month").agg(
    ...
    return df_web_monthly_timeband_agg_category
