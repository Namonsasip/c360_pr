...
def add_relative_time_features(data_frame: DataFrame) -> DataFrame:
    ...
    data_frame = data_frame.withColumn(
        ...
        , F.col("sum_campaign_total_others_by_eligible_call_center_sum_weekly_last_four_week")
          / F.col("sum_campaign_total_others_by_eligible_call_center_sum_weekly_last_twelve_week")
    ) \
        .withColumn("sum_campaign_total_others_success_by_call_center_sum_weekly_four_week_over_twelve_weeks"
                    , F.col("sum_campaign_total_others_by_eligible_call_center_sum_weekly_last_four_week")
                    / F.col("sum_campaign_total_others_by_eligible_call_center_sum_weekly_last_twelve_week")
                    ) \
        .withColumn(
