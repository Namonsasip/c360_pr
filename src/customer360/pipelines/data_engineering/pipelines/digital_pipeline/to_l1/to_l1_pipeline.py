...
def digital_to_l1_digital_mobile_web_agg_daily(**kwargs):
    return Pipeline(
        [
            ...
            # node(
            #     func=l1_digital_customer_web_category_agg_daily_temp,
            #     inputs=["int_l1_digital_customer_web_category_agg_daily_catlv_1", "l1_digital_cxense_traffic_complete_agg_daily_for_l1_dital_customer_web_agg_daily_catlv_1"],
            #     outputs="l1_digital_customer_web_category_agg_daily_catlv_1",
            #     tags="l1_digital_customer_web_category_agg_daily_catlv_1"
            # ),  # temp web agg category daily level 1
            node(
            ...
            node(
                func=l1_digital_customer_web_category_agg_daily_cat_level_temp,
                inputs=["int_l1_digital_customer_web_category_agg_daily_catlv_2", "l1_digital_cxense_traffic_complete_agg_daily_for_l1_dital_customer_web_agg_daily_catlv_2"],
                outputs="l1_digital_customer_web_category_agg_daily_catlv_2",
                tags="l1_digital_customer_web_category_agg_daily_catlv_2"
            ),  # temp web agg category daily level 2
            node(
                func=l1_digital_customer_web_category_agg_daily_cat_level,
                inputs=
                [
            ...
            node(
                func=l1_digital_customer_web_category_agg_daily_cat_level_temp,
                inputs=["int_l1_digital_customer_web_category_agg_daily_catlv_3", "l1_digital_cxense_traffic_complete_agg_daily_for_l1_dital_customer_web_agg_daily_catlv_3"],
                outputs="l1_digital_customer_web_category_agg_daily_catlv_3",
                tags="l1_digital_customer_web_category_agg_daily_catlv_3"
            ),  # temp web agg category daily level 3
            node(
                func=l1_digital_customer_web_category_agg_daily_cat_level,
                inputs=
                [
            ...
            node(
                func=l1_digital_customer_web_category_agg_daily_cat_level_temp,
                inputs=["int_l1_digital_customer_web_category_agg_daily_catlv_4", "l1_digital_cxense_traffic_complete_agg_daily_for_l1_dital_customer_web_agg_daily_catlv_4"],
                outputs="l1_digital_customer_web_category_agg_daily_catlv_4",
                tags="l1_digital_customer_web_category_agg_daily_catlv_4"
            ),  # temp web agg category daily level 4
