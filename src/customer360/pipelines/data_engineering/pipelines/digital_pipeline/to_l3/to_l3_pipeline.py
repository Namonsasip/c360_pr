    ...
    return Pipeline(
        [
            node(
                ...
                tags="l3_digital_customer_web_category_agg_monthly_morning_catlv_1"
            ),
            node(
                func=l3_digital_mobile_web_category_agg_timeband,
                ...
                tags="l3_digital_customer_web_category_agg_monthly_afternoon_catlv_1"
            ),
            node(
                func=l3_digital_mobile_web_category_agg_timeband,
                ...
                tags="l3_digital_customer_web_category_agg_monthly_evening_catlv1"
            ),
            node(
                func=l3_digital_mobile_web_category_agg_timeband,
                ...
                tags="l3_digital_customer_web_category_agg_monthly_night_catlv_1"
            ),
        ],
    )
