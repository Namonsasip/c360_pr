...
from customer360.pipelines.data_engineering.nodes.usage_nodes.to_l4.to_l4 import l4_usage_rolling_window_weekly, \
    ...
    l4_usage_split_column_by_maxdate_test, split_category_rolling_windows, split_category_rolling_windows_by_metadata, \
...
def usage_to_l4_pipeline_max(**kwargs):
    return Pipeline(
        [
            ...
            # ),
            # node(
            #     l4_usage_merge_all_column,
            #     ["l4_usage_postpaid_prepaid_weekly_features_max_first",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_second",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_third",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_fourth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_fifth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_sixth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_seventh",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_eighth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_ninth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_tenth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_eleventh",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_twelfth",
            #      "l4_usage_postpaid_prepaid_weekly_features_max_thirteenth"],
...
def usage_to_l4_pipeline_avg(**kwargs):
    return Pipeline(
        [
            node(
                split_category_rolling_windows_by_metadata,
            ...
            # node(
            #     l4_usage_rolling_window_split_column_avg,
            #     ["l2_usage_postpaid_prepaid_weekly_for_l4_postpaid_prepaid_weekly_features_avg",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set1",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set2",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set3",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set4",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set5",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set6",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set7",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set8",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set9",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set10",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set11",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set12",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set13",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set14",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set15",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set16",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set17",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set18",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set19",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set20",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set21",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set22",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set23",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set24",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_set25",
            #      "params:l4_usage_postpaid_prepaid_weekly_features_avg_tg"],
            #     "l4_usage_postpaid_prepaid_weekly_features_avg"
            # ),
