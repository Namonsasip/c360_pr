...
from customer360.pipelines.data_engineering.nodes.usage_nodes.to_l1.to_l1_nodes import l1_usage_most_idd_features, \
    usage_outgoing_voice_sms_ins_pipeline, usage_data_gprs_ins_pipeline, merge_all_dataset_to_one_table_notfull
...
def usage_to_l1_pipeline(**kwargs):
    return Pipeline(
        [
            ...
            # l1_usage_postpaid_prepaid_daily wtihout source l1_usage_gprs_ins_usage_daily
