...
def revenue_to_l4_pipeline(**kwargs):
    return Pipeline(
        [
            ...
            #     "l4_revenue_prepaid_ru_f_sum_revenue_by_service_monthly_features"
            # ),
            node(
                l4_rolling_window,
                ["l3_revenue_prepos_ru_f_sum_revenue_by_service_monthly",
                 "params:l4_revenue_prepos_ru_f_sum_revenue_by_service_monthly_int"],
                "l4_revenue_prepos_ru_f_sum_revenue_by_service_monthly_stg"
            ),

            node(
                node_from_config,
                ["l4_revenue_prepos_ru_f_sum_revenue_by_service_monthly_stg",
                 "params:l4_revenue_prepos_ru_f_sum_revenue_by_service_monthly"],
                "l4_revenue_prepos_ru_f_sum_revenue_by_service_monthly"
            ),
