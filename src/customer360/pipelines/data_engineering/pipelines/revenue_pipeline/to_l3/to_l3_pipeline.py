...
from customer360.pipelines.data_engineering.nodes.revenue_nodes.to_l3 import merge_with_customer_df
...
def revenue_to_l3_pipeline(**kwargs):
    return Pipeline(
        [
            ...
            node(merge_with_customer_df, 'l3_revenue_prepaid_ru_f_sum_revenue_by_service_monthly_stg',
