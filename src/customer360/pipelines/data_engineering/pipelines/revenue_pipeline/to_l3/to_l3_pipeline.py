    ...
    return Pipeline(
        [
            ...
            node(
                node_from_config,
                ['l3_revenue_features_postpaid_ru_f_sum_revenue_by_service_monthly_revenue_stg1',
                 'params:l3_revenue_features_postpaid_monthly_revenue'],
                'l3_revenue_features_postpaid_monthly_revenue'
            ),
            node(
                node_from_config,
                ['l0_revenue_prepaid_pru_f_revenue_allocate_usage_revenue',
            ...
            node(
                node_from_config,
                ['l3_revenue_features_postpaid_ru_f_sum_revenue_by_service_monthly_revenue_stg1',
                 'params:l3_revenue_features_prepaid_monthly_revenue'],
                'l3_revenue_features_prepaid_monthly_revenue'
            ),
        ]
    )
