    ...
    return Pipeline(
        [
            node(
                ...
                ['l0_campaign_tracking_contact_list_post', 'params:l1_cam_post_channel_with_highest_conversion'],
                ['l1_cam_post_channel_with_highest_conversion', 'l1_campaign_top_channel']
            )
