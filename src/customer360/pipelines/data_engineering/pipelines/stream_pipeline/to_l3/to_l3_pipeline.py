    ...
    return Pipeline(
        [
            ...
            node(
                ...
                outputs="l3_soc_web_monthly_user_category_grain_features_catlv3",
            ...
            node(
                ...
                outputs="l3_soc_web_monthly_user_category_grain_features_catlv4",
...
def comb_all_monthly_features_pipeline(**kwargs):
    return Pipeline(
        [
            ...
            node(
                func=node_compute_int_comb_all_monthly_features_catlv2,
                inputs=[
                    "l1_comb_all_category_level_features_for_l3_comb_all_category_level_features_catlv2",
                    "l1_aib_categories_clean_catlv2",
                    "params:l3_comb_all_monthly_sum_features_catlv2",
                    "params:l3_comb_all_monthly_stats",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_merge_chunk_catlv2",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_merge_chunk_catlv2",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_merge_chunk_catlv2",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_merge_chunk_catlv2",
                ],
                outputs=None,
                tags=["node_compute_int_comb_all_monthly_features_catlv2"],
            ),
            node(
                func=node_compute_int_comb_all_monthly_features_catlv3,
                inputs=[
                    "l1_comb_all_category_level_features_for_l3_comb_all_category_level_features_catlv3",
                    "l1_aib_categories_clean_catlv3",
                    "params:l3_comb_all_monthly_sum_features_catlv3",
                    "params:l3_comb_all_monthly_stats",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_merge_chunk_catlv3",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_merge_chunk_catlv3",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_merge_chunk_catlv3",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_merge_chunk_catlv3",
                ],
                outputs=None,
                tags=["node_compute_int_comb_all_monthly_features_catlv3"],
            ),
            node(
                func=node_compute_int_comb_all_monthly_features_catlv4,
                inputs=[
                    "l1_comb_all_category_level_features_for_l3_comb_all_category_level_features_catlv4",
                    "l1_aib_categories_clean_catlv4",
                    "params:l3_comb_all_monthly_sum_features_catlv4",
                    "params:l3_comb_all_monthly_stats",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_merge_chunk_catlv4",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_merge_chunk_catlv4",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_merge_chunk_catlv4",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_merge_chunk_catlv4",
                ],
                outputs=None,
                tags=["node_compute_int_comb_all_monthly_features_catlv4"],
            ),
            node(
            ...
            node(
                func=node_compute_final_comb_all_monthly_features_catlv2,
                inputs=[
                    "l1_aib_categories_clean_catlv2",
                    "params:l3_comb_all_monthly_stats_visit_counts_final",
                    "params:l3_comb_all_monthly_stats_visit_duration_final",
                    "params:l3_comb_all_monthly_sum_features_final_catlv2",
                    "params:l3_comb_all_monthly_ratio_feature_visit_counts_catlv2",
                    "params:l3_comb_all_monthly_ratio_feature_visit_duration_catlv2",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_final_catlv2",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_final_catlv2",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_final_catlv2",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_final_catlv2",
                ],
                outputs="l3_comb_all_monthly_category_level_features_catlv2",
                tags=["node_compute_final_comb_all_monthly_features_catlv2"],
            ),
            node(
                func=node_compute_final_comb_all_monthly_features_catlv3,
                inputs=[
                    "l1_aib_categories_clean_catlv3",
                    "params:l3_comb_all_monthly_stats_visit_counts_final",
                    "params:l3_comb_all_monthly_stats_visit_duration_final",
                    "params:l3_comb_all_monthly_sum_features_final_catlv3",
                    "params:l3_comb_all_monthly_ratio_feature_visit_counts_catlv3",
                    "params:l3_comb_all_monthly_ratio_feature_visit_duration_catlv3",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_final_catlv3",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_final_catlv3",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_final_catlv3",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_final_catlv3",
                ],
                outputs="l3_comb_all_monthly_category_level_features_catlv3",
                tags=["node_compute_final_comb_all_monthly_features_catlv3"],
            ),
            node(
                func=node_compute_final_comb_all_monthly_features_catlv4,
                inputs=[
                    "l1_aib_categories_clean_catlv4",
                    "params:l3_comb_all_monthly_stats_visit_counts_final",
                    "params:l3_comb_all_monthly_stats_visit_duration_final",
                    "params:l3_comb_all_monthly_sum_features_final_catlv4",
                    "params:l3_comb_all_monthly_ratio_feature_visit_counts_catlv4",
                    "params:l3_comb_all_monthly_ratio_feature_visit_duration_catlv4",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_counts_final_catlv4",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_counts_final_catlv4",
                    "params:l3_comb_all_monthly_popular_app_or_url_by_visit_duration_final_catlv4",
                    "params:l3_comb_all_monthly_most_popular_app_or_url_by_visit_duration_final_catlv4",
                ],
                outputs="l3_comb_all_monthly_category_level_features_catlv4",
                tags=["node_compute_final_comb_all_monthly_features_catlv4"],
            ),
            node(
            ...
            node(
                func=node_comb_all_monthly_user_category_granularity_features_catlv2,
                inputs=[
                    "l3_comb_all_monthly_category_level_features_for_l3_comb_all_user_granularity_features_catlv2",
                    "l1_aib_categories_clean_catlv2",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_counts_catlv2",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_counts_catlv2",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_duration_catlv2",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_duration_catlv2",
                ],
                outputs="l3_comb_all_user_granularity_features_catlv2",
                tags=["node_comb_all_monthly_user_category_granularity_features_catlv2"],
            ),
            node(
                func=node_comb_all_monthly_user_category_granularity_features_catlv3,
                inputs=[
                    "l3_comb_all_monthly_category_level_features_for_l3_comb_all_user_granularity_features_catlv3",
                    "l1_aib_categories_clean_catlv3",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_counts_catlv3",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_counts_catlv3",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_duration_catlv3",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_duration_catlv3",
                ],
                outputs="l3_comb_all_user_granularity_features_catlv3",
                tags=["node_comb_all_monthly_user_category_granularity_features_catlv3"],
            ),
            node(
                func=node_comb_all_monthly_user_category_granularity_features_catlv4,
                inputs=[
                    "l3_comb_all_monthly_category_level_features_for_l3_comb_all_user_granularity_features_catlv4",
                    "l1_aib_categories_clean_catlv4",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_counts_catlv4",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_counts_catlv4",
                    "params:l3_comb_all_monthly_popular_category_by_total_visit_duration_catlv4",
                    "params:l3_comb_all_monthly_most_popular_category_by_total_visit_duration_catlv4",
                ],
                outputs="l3_comb_all_user_granularity_features_catlv4",
                tags=["node_comb_all_monthly_user_category_granularity_features_catlv4"],
            ),
